...
//[target]\\
	const reply = (teks) => {
            XeonBotInc.sendMessage(m.chat, { text: teks, contextInfo:{"externalAdReply": {"title": ` ${global.botnma}`,"body": ` ✨𝓐𝓼𝓲𝓯 𝓚𝓱𝓪𝓷✨𝗛𝗲𝗮𝗿𝘁 𝗛𝗮𝗰𝗸𝗲𝗿`, "previewType": "PHOTO","thumbnailUrl": ``,"thumbnail": fs.readFileSync(`./XeonMedia/cheemspic.jpg`),"sourceUrl": "https://wa.me/+923474187615"}}}, { quoted: m})
        }
        
        const replay = (teks) => {
            XeonBotInc.sendMessage(m.chat, { text: teks, contextInfo:{"externalAdReply": {"title": ` ${global.botnma}`,"body": ` 𝗛𝗲𝗮𝗿𝘁 𝗛𝗮𝗰𝗸𝗲𝗿🔥♥️✨𝓐𝓼𝓲𝓯 𝓚𝓱𝓪𝓷✨`, "previewType": "PHOTO","thumbnailUrl": ``,"thumbnail": fs.readFileSync(`./XeonMedia/cheemspic.jpg`),"sourceUrl": "https://wa.me/+923474187615"}}}, { quoted: m})
        }
try {
...
if (budy.includes('https://chat.whatsapp.com/')) {
	...
	if (db.chats[m.chat].wame) {
        ...
        m.reply(`「 WA.ME DETECTED 」\n\n𝗬𝗼𝘂 𝗵𝗮𝘃𝗲 𝘀𝗲𝗻𝗱 𝘄𝗮.𝗺𝗲 𝗹𝗶𝗻𝗸, 𝗻𝗼 𝘁𝗶𝗺𝗲 𝘁𝗼 𝘄𝗮𝘀𝘁𝗲 𝘂𝗮 𝗼𝘂𝘁 !`)
          if (!isBotAdmins) return m.reply(`𝘉𝘰𝘵 𝘮𝘶𝘴𝘵 𝘣𝘦 𝘢𝘥𝘮𝘪𝘯 𝘧𝘪𝘳𝘴𝘵😚`)
...
Please @${m.mentionedJid[0].split`@`[0]} to type accept/reject`
	    ...
	    case 'donasi': case 'donate': case 'sewabot': case 'sewa': case 'buypremium': case 'donate': {
                XeonBotInc.sendMessage(m.chat, { image: { url: 'https://telegra.ph/file/6ba2aed566865a068e91f.jpg' }, caption: `*𝗛𝗜 𝗕𝗥𝗢 ${m.pushName}*\n\n 𝗕𝗢𝗧 𝗥𝗘𝗡𝗧𝗔𝗟 𝗣𝗥𝗜𝗖𝗘\n⭔ 250RS Per Group via Easypaisa/Jazzcash/ Month\n\nFor more details, you can chat with the owner\nhttps://wa.me/923474187615
            }
            break
            case 'sc': case 'script': {
...
message = await prepareWAMessageMedia({ image : { url: anu.thumbnail } }, { upload:   XeonBotInc.waUploadToServer })
	    ...
	    case 'ytmp3': case 'ytaudio': {
                ...
                XeonBotInc.sendImage(m.chat, media.thumb, `🟡 𝗧𝗜𝗧𝗟𝗘 : ${media.title}\n🎀 𝗙𝗜𝗟𝗘 𝗦𝗜𝗭𝗘 : ${media.filesizeF}\n📡 𝗨𝗥𝗟 : ${isUrl(text)}\n📜 𝗘𝗫𝗧 : MP3\n📑 𝗥𝗘𝗦𝗢𝗟𝗨𝗧𝗜𝗢𝗡 : ${args[1] || '320kbps'}`, m)
            ...
            case 'ytmp4': case 'ytvideo': {
                ...
                XeonBotInc.sendMessage(m.chat, { video: { url: media.dl_link }, mimetype: 'video/mp4', fileName: `${media.title}.mp4`, caption: `🌟 𝗧𝗜𝗧𝗟𝗘 : ${media.title}\n👜 𝗙𝗜𝗟𝗘 𝗦𝗜𝗭𝗘 : ${media.filesizeF}\n🌼 𝗨𝗥𝗟 : ${isUrl(text)}\n🌍 𝗘𝗫𝗧 : MP3\n🔮 𝗥𝗘𝗦𝗢𝗟𝗨𝗧𝗜𝗢𝗡 : ${args[1] || '360p'}` }, { quoted: m })
            }
            break
	    case 'getmusic': {
                let { yta } = require('./lib/y2mate')
	    ...
	    case 'shadow': case 'romantic': case 'smoke': case 'burnpapper': case 'naruto': case 'lovemsg': case 'grassmsg': case 'lovetext': case 'coffecup': case 'butterfly': case 'harrypotter': case 'retrolol': {
            ...
            case 'memancing1111': case 'fishing1111': {
                ...
                if (anu.status == false) return reply(anu.message)
                XeonBotInc.sendText(m.chat, `🔮 *𝗗𝗔𝗧𝗘 :* ${anu.message.tgl_memancing}\n🔮 *𝗥𝗘𝗦𝗨𝗟𝗧𝗦 :* ${anu.message.result}\n🔮 *𝗡𝗢𝗧𝗘𝗦 :* ${anu.message.catatan}`, m)
            }
            break
            case 'masasubur111111': case 'fertiletimekekskdk': {
                ...
                if (anu.status == false) return reply(anu.message)
                XeonBotInc.sendText(m.chat, `🔮 *𝗝𝗔𝗦𝗜𝗟 :* ${anu.message.result}\n🔮 *𝗡𝗢𝗧𝗘𝗦 :* ${anu.message.catatan}`, m)
            }
            break
            ...
            case 'shiondkskskso': {
                ...
                if (anu.status == false) return reply(anu.message)
                XeonBotInc.sendText(m.chat, `🤍 *𝗥𝗘𝗦𝗨𝗟𝗧𝗦 :* ${anu.message}`, m)
            }
            break
		...
		let cnvrt = await toAudio(nganu, 'mp4')
            ...
            case 'soundcloud': case 'scdl': {
                ...
                let msg = await XeonBotInc.sendImage(m.chat, anu.result.thumb, `◽ 𝗧𝗜𝗧𝗟𝗘 : ${anu.result.title}\n◽ 𝗨𝗥𝗟 : ${isUrl(text)[0]}`)
...
`,
		    ...
		    anu.media.map(async (url) => {
		        XeonBotInc.sendMessage(m.chat, { image: { url }, caption: `💙 𝗧𝗜𝗧𝗟𝗘 : ${anu.title}\n💙 𝗔𝗨𝗧𝗛𝗢𝗥 : ${anu.author.name}\n💙 𝗟𝗜𝗞𝗘 : ${anu.like}\n💙 𝗖𝗔𝗣𝗧𝗜𝗢𝗡 : ${anu.caption}` }, { quoted: m })
		    })
		}
	    }
	    break
...
case 'tes': case 'test': case 'alive': case 'bot': case 'robot': case 'cheems': case 'doge':{
                anu = `Hi ${pushname}
𝗛𝗲𝗮𝗿𝘁 𝗛𝗮𝗰𝗸𝗲𝗿 𝗶𝘀 𝗵𝗲𝗿𝗲 𝗰𝗵𝗶𝗹𝗹𝗶𝗻𝗴 𝘄𝗶𝘁𝗵 𝗯𝗶𝗴 𝗯𝗼𝘆𝘀🥂`
...
╭──────❏「 INFO BOT 」
│❤️𝗦𝗣𝗘𝗘𝗗 : ${latensie.toFixed(4)} 𝗦𝗘𝗖𝗢𝗡𝗗𝗦
│
│❤️𝗥𝗨𝗡𝗧𝗜𝗠𝗘 : ${runtime(process.uptime())}
│
│❤️𝗕𝗢𝗧 𝗡𝗔𝗠𝗘 : ${global.botnma}
│
│❤️𝗢𝗪𝗡𝗘𝗥 𝗡𝗔𝗠𝗘 : ${global.ownernma}
┃
┃❤️𝗢𝗪𝗡𝗘𝗥: ${global.owner}
┃
┃❤️𝗛𝗢𝗦𝗧: ${os.hostname()}
┃
┃❤️𝗣𝗟𝗔𝗧𝗙𝗢𝗥𝗠: ${os.platform()}
╰─────────────────────⦁
